...
@Component({
  selector: 'app-a-z-brands-id',
  templateUrl: './a-z-brands-id.component.html',
  styleUrls: ['./a-z-brands-id.component.scss']
})
export class AZBrandsIdComponent implements OnInit {
