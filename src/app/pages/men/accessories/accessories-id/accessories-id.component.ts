...
@Component({
  selector: 'app-accessories-id',
  templateUrl: './accessories-id.component.html',
  styleUrls: ['./accessories-id.component.scss']
})
export class AccessoriesIdComponent implements OnInit {
