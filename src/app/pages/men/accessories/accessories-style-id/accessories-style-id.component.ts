...
@Component({
  selector: 'app-accessories-style-id',
  templateUrl: './accessories-style-id.component.html',
  styleUrls: ['./accessories-style-id.component.scss']
})
export class AccessoriesStyleIdComponent implements OnInit {
