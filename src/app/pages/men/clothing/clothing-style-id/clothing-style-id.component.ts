...
@Component({
  selector: 'app-clothing-style-id',
  templateUrl: './clothing-style-id.component.html',
  styleUrls: ['./clothing-style-id.component.scss']
})
export class ClothingStyleIdComponent implements OnInit {
