...
@Component({
  selector: 'app-new-products-id',
  templateUrl: './new-products-id.component.html',
  styleUrls: ['./new-products-id.component.scss']
})
export class NewProductsIdComponent implements OnInit {
