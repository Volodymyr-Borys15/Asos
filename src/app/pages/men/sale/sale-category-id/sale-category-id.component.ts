...
@Component({
  selector: 'app-sale-category-id',
  templateUrl: './sale-category-id.component.html',
  styleUrls: ['./sale-category-id.component.scss']
})
export class SaleCategoryIdComponent implements OnInit {
