...
@Component({
  selector: 'app-shoes-style-id',
  templateUrl: './shoes-style-id.component.html',
  styleUrls: ['./shoes-style-id.component.scss']
})
export class ShoesStyleIdComponent implements OnInit {
