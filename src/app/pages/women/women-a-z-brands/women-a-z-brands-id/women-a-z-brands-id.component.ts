...
@Component({
  selector: 'app-women-a-z-brands-id',
  templateUrl: './women-a-z-brands-id.component.html',
  styleUrls: ['./women-a-z-brands-id.component.scss']
})
export class WomenAZBrandsIdComponent implements OnInit {
