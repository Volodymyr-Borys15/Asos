...
@Component({
  selector: 'app-women-a-z-brands-style-id',
  templateUrl: './women-a-z-brands-style-id.component.html',
  styleUrls: ['./women-a-z-brands-style-id.component.scss']
})
export class WomenAZBrandsStyleIdComponent implements OnInit {
