...
@Component({
  selector: 'app-women-accessories-id',
  templateUrl: './women-accessories-id.component.html',
  styleUrls: ['./women-accessories-id.component.scss']
})
export class WomenAccessoriesIdComponent implements OnInit {
