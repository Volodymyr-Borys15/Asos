...
@Component({
  selector: 'app-women-accessories-style-id',
  templateUrl: './women-accessories-style-id.component.html',
  styleUrls: ['./women-accessories-style-id.component.scss']
})
export class WomenAccessoriesStyleIdComponent implements OnInit {
