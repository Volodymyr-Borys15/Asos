...
@Component({
  selector: 'app-women-accessories-style',
  templateUrl: './women-accessories-style.component.html',
  styleUrls: ['./women-accessories-style.component.scss']
})
export class WomenAccessoriesStyleComponent implements OnInit {
