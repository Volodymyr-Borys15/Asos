...
@Component({
  selector: 'app-women-clothing-id',
  templateUrl: './women-clothing-id.component.html',
  styleUrls: ['./women-clothing-id.component.scss']
})
export class WomenClothingIdComponent implements OnInit {
