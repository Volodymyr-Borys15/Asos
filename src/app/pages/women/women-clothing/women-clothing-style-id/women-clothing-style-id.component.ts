...
@Component({
  selector: 'app-women-clothing-style-id',
  templateUrl: './women-clothing-style-id.component.html',
  styleUrls: ['./women-clothing-style-id.component.scss']
})
export class WomenClothingStyleIdComponent implements OnInit {
