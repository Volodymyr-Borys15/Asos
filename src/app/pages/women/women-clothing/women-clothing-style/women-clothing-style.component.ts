...
@Component({
  selector: 'app-women-clothing-style',
  templateUrl: './women-clothing-style.component.html',
  styleUrls: ['./women-clothing-style.component.scss']
})
export class WomenClothingStyleComponent implements OnInit {
  ...
  private getData(currentStyle?): void {
    ...
    this.subscription = this.serviceProduct.getWomenProductStylePag(this.page, currentStyle).subscribe((data) => {
