...
@Component({
  selector: 'app-women-new-category-id',
  templateUrl: './women-new-category-id.component.html',
  styleUrls: ['./women-new-category-id.component.scss']
})
export class WomenNewCategoryIdComponent implements OnInit {
