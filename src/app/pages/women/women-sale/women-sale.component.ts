...
@Component({
  ...
  styleUrls: ['./women-sale.component.scss']
})
export class WomenSaleComponent implements OnInit {
  ...
  private getData(): void {
   this.subscription = this.salesService.getWomenSalesPagin(this.pageCurrent).subscribe(data => {
      this.sales = data;
    },
      err => {
        console.log(err);
