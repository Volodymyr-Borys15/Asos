...
@Component({
  selector: 'app-women-shoes-id',
  templateUrl: './women-shoes-id.component.html',
  styleUrls: ['./women-shoes-id.component.scss']
})
export class WomenShoesIdComponent implements OnInit {
