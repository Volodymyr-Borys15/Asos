...
@Component({
  selector: 'app-women-shoes-style-id',
  templateUrl: './women-shoes-style-id.component.html',
  styleUrls: ['./women-shoes-style-id.component.scss']
})
export class WomenShoesStyleIdComponent implements OnInit {
